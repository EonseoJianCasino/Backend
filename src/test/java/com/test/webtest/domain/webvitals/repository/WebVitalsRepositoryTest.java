...
class WebVitalsRepositoryTest {
    ...
    void save_AndFindById_ShouldWork() {
        // given
        TestEntity test = TestEntity.create("https://www.example.com", "127.0.0.1");
    ...
    void findAll_ShouldReturnAllEntities() {
        // given
        TestEntity test1 = TestEntity.create("https://www.example.com", "127.0.0.1");
        entityManager.persist(test1);

        TestEntity test2 = TestEntity.create("https://www.test.com", "127.0.0.2");
