...
import com.test.webtest.domain.webvitals.entity.TtfbEntity;
...
public interface TtfbRepository extends JpaRepository<TtfbEntity, UUID> {
    Optional<TtfbEntity> findByTest_Id(UUID testId); // test 연관 필드 경유
