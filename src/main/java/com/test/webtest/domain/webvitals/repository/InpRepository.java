...
import com.test.webtest.domain.webvitals.entity.InpEntity;
...
public interface InpRepository extends JpaRepository<InpEntity, UUID> {
    Optional<InpEntity> findByTest_Id(UUID testId); // test 연관 필드 경유
