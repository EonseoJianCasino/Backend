...
import com.test.webtest.domain.webvitals.entity.FcpEntity;
...
public interface FcpRepository extends JpaRepository<FcpEntity, UUID> {
    Optional<FcpEntity> findByTest_Id(UUID testId); // test 연관 필드 경유
